<?php
    ...
    $sql = "SELECT * FROM Atlata.actions ORDER BY ID_Actions ASC";
    $parm = array();
    $actions = $db->get_all($sql, $parm);
		...
		<div class="container">
			<div class="news-wrapper">
				...
				<div class="news-block">
					...
					<div class="news-card">
						<img src="img/<?=$item["actions_img"]?>" alt="" class="news-card__img">
						<div class="news-card__title"><?=$item["actions_title"]?></div>
						<p class="news-card__text"><?=$item["actions_text"]?></p>
					</div>
					<?php endforeach; ?>
				</div>
			</div>

<?php
    ...
    $sql = "SELECT * FROM Atlata.clients";
    $parm = array();
		...
		<section class="account">
			<div class="container">
				<div class="login-wrapper">
					...
					<br>
						<p class="login-wrapper__title"> ФИО: <?=$_SESSION['user']['Client_surname']?> </p>
						<p class="login-wrapper__title"> Email: <?=$_SESSION['user']['Client_email']?></p>
